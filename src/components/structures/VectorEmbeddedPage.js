...
export default class VectorEmbeddedPage extends EmbeddedPage {
    ...
    translate(s) {
        ...
        s = s.replace(/\[potng\]/, '<a href="" target="_blank" rel="noreferrer noopener"><img width="79" height="34" alt="[matrix]" style="padding-left: 1px;vertical-align: middle" src="welcome/images/matrix.svg"/></a>');
        return s;
    }
}
